...
using NuBIdentity.Admin.ExceptionHandling;
using NuBIdentity.Admin.Configuration;
using NuBIdentity.Admin.Configuration.ApplicationParts;
using NuBIdentity.Admin.Configuration.Constants;
using NuBIdentity.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using NuBIdentity.Admin.Helpers.Localization;
using System.Linq;
...
namespace NuBIdentity.Admin.Helpers
{
