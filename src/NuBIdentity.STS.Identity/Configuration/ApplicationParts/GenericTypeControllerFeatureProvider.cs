...
namespace NuBIdentity.STS.Identity.Configuration.ApplicationParts
{
    public class GenericTypeControllerFeatureProvider<TUser, TKey, TRole> : IApplicationFeatureProvider<ControllerFeature>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        {
            var currentAssembly = typeof(GenericTypeControllerFeatureProvider<TUser, TKey, TRole>).Assembly;
