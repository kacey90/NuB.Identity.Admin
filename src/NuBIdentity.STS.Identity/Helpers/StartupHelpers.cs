...
using SendGrid;
using NuBIdentity.STS.Identity.Configuration;
using NuBIdentity.STS.Identity.Configuration.ApplicationParts;
using NuBIdentity.STS.Identity.Configuration.Constants;
using NuBIdentity.STS.Identity.Configuration.Interfaces;
using NuBIdentity.STS.Identity.Helpers.Localization;
using NuBIdentity.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using NuBIdentity.Admin.EntityFramework.MySql.Extensions;
using NuBIdentity.Admin.EntityFramework.PostgreSQL.Extensions;
using NuBIdentity.Admin.EntityFramework.Shared.Configuration;
using NuBIdentity.Admin.EntityFramework.SqlServer.Extensions;
...
namespace NuBIdentity.STS.Identity.Helpers
{
    public static class StartupHelpers
    {
        ...
        public static IMvcBuilder AddMvcWithLocalization<TUser, TKey, TRole>(this IServiceCollection services, IConfiguration configuration)
            ...
            where TKey : IEquatable<TKey>
        {
            ...
            var mvcBuilder = services.AddControllersWithViews(o =>
                ...
                {
                    m.FeatureProviders.Add(new GenericTypeControllerFeatureProvider<TUser, TKey, TRole>());
                });
            ...
            where TUserIdentityRole : class
        {
            ...
            services.AddScoped<SecurityFilterAttribute>();
